...
Распознавай накрученные отзывы и не учитывай их в подборке плюсов и минусов товара. Накрученные отзывы очень легко отличить от настоящих. Их выделяют множество признаков, вот некоторые из них:
