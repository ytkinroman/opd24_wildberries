...
Важно: Если плюсов у товара нет, то пиши в пункте 'Плюсы:' — "Не нашёл плюсов", точно так же с минусами 'Минусы:' — 'Не нашёл минусов'. Количество плюсов и минусов не фиксировано.
Не повторяйся!
Список плюсов и минусов должен быть ненумерованным, используй вместо цифр " - ".

Вот макет ответа с рядом инструкций:
Описание товара:
Начни описание товара с короткого и ясного обзора. Укажи основные характеристики товара.
...
Заключение:
Сформулируй краткое и обобщающее заключение о товаре на основе предоставленных отзывов.
"""
