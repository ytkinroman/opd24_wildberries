...
'''
Описание товара:
Начните описание товара с короткого и ясного обзора. Укажи основные характеристики товара.
...
Не повторяйся!
Список плюсов и минусов должен быть не нумерованным. Используй вместо цифр " - ".
"""
